...
import { createSchema, updateSchema, querySchema, paramsSchema } from './attendance.schema';

export const attendanceRouter = Router();

attendanceRouter.get('/', validateQuery(querySchema), requireRole(...ROLE_GROUPS.TEACHING), ctrl.list);
attendanceRouter.get('/:id', validateParams(paramsSchema), requireRole(...ROLE_GROUPS.ALL_AUTHENTICATED), ctrl.getById);
